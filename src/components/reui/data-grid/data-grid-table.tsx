...
function DataGridTableBase({ children }: { children: ReactNode }) {
  ...
  const columnSizeVars = useMemo(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- TanStack table ref is stable; sizing updates use columnSizing* slices above
    [props.tableLayout?.columnsResizable, columnSizingInfo, columnSizing],
  );
...
function DataGridTableViewport({
  ...
  useEffect(() => {
    ...
    queueMicrotask(syncContainerWidth);
