...
function DataGridProvider<TData extends object>({
  ...
  // Align TanStack resize behavior with DataGrid props without mutating
  // `table.options` during render (React Compiler disallows that).
  useLayoutEffect(() => {
    if (!props.tableLayout?.columnsResizable) return;
    if (table.options.columnResizeMode === resolvedColumnsResizeMode) return;
