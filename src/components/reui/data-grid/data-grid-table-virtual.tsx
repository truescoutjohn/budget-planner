...
function DataGridTableVirtual<TData>({
  ...
  // TanStack Virtual returns unstable function refs; React Compiler skips this subtree by design.
  ...
  useEffect(() => {
    ...
    if (lastVirtualVisibleIndex < 0) return;

    if (
      lastVirtualVisibleIndex >=
